          ...
          (list
           ...
           (make-decision
            ...
            (thunk
             ...
             (if (attribute-check "Charisma" (actor-charisma (pc)))
                 'anthill-grabberkin-fingers-haggle-success
                 'anthill-grabberkin-fingers-haggle-fail))
            )
           (make-decision
            #:title "Disagree."
            #:description "\"NO DEAL.\", Otava says and leaves."
...
(fragment 'anthill-grabberkin-fingers-haggle-success
          "\"NEW CAUSES <–> NEW EFFECTS. EFFECT: 3 GRAMS.\", Anthill finally agrees."
          #:on-after-describe!
          (thunk
           (add-new-task!
            (task
...
(fragment 'anthill-grabberkin-fingers-haggle-fail
          '()
          #:on-before-describe!
          (thunk
