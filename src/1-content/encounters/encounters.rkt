...
(define (grabberkin-spawn-text)
  ...
  (case times-encountered
    ...
    [(2)
     "A Grabberkin grips Otava by the shin and tries to bring her to the ground, jealous of what it can't have."]
...
(define (blindscraper-spawn-text)
  ...
  (case times-encountered
    [(0)
     "A many-jointed fingerlike appendage, long as a forearm, extends and folds through the shadows. At the tip of the slender limb is a curving shiny black claw. The first finger is followed by several more, then a sac-like, limply hanging body."]
