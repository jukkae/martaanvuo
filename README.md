...
- Install Racket packages: `text-table`, `rebellion`, `reprovide-lang-lib`, `rackjure`, and `mred-designer` (if not installed). (`raco pkg install --auto text-table rebellion reprovide-lang-lib rackjure mred-designer`
